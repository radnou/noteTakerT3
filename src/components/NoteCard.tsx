...
export const NoteCard = ({
  ...
  return (
    <div
      className={
        "card mt-5 flex flex-col border-gray-200 bg-base-100 shadow-xl"
      }
    >
      <div className={"card-body m-0 flex flex-col pt-3"}>
        <div
        ...
        <div className={"flex-justify-end card-actions mx-2"}>
          <button
            className={" btn-primary  btn px-5 hover:bg-primary-focus"}
            onClick={onEdit}
          >
            <svg
          ...
          <button
            className={" btn-warning btn px-5 hover:bg-error"}
            onClick={onDelete}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
